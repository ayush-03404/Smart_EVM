 ...
 *  WIRING
 *  ─────────────────────────────────────────────────────────
 *  Candidate 1 button : D1 (GPIO5)  → GND   (no resistor needed)  [Physics]
 *  Candidate 2 button : D2 (GPIO4)  → GND                         [Chemistry]
 *  Candidate 3 button : D7 (GPIO13) → GND                         [Mathematics]
 *  Candidate 4 button : D6 (GPIO12) → GND                         [Biology]
 *  Candidate 5 button : D5 (GPIO14) → GND                         [UNUSED — no candidate assigned]
