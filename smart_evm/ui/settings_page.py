"""
ui/settings_page.py — Candidate name editor and session controls.
"""
...
from config import COLORS, CANDIDATE_COUNT, WS_PORT
...
class SettingsPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        sub = QLabel("Edit the names mapped to each hardware candidate ID (1–5).")
