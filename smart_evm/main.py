...
# -----------------------------------------------------------------------
# AUTO-INSTALL — works whether the user runs `py main.py`, `python main.py`
# or double-clicks START.bat.  Installs only what is missing so it's fast
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        ver_lbl.setStyleSheet(f"color: {COLORS['border']}; font-size: 10px; padding: 8px;")
        ...
        for page in (self._dashboard, self._results, self._logs, self._settings, self._export):
    ...
    def _on_esp_connected(self, addr: str) -> None:
        ...
        log.info("ESP8266 connected: %s", addr)
    ...
    def _on_error(self, reason: str) -> None:
        # Record error events with candidate_id=0 as a sentinel
